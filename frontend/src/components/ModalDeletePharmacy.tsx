...
const ModalDeletePharmacy = ({
  ...
  return (
    <>
      ...
      ></div>
      <div className="w-[30vw] h-[auto] fixed z-[150] top-[25vh] left-[35vw] justify-between items-center flex flex-col rounded-xl bg-[#DFF1FD] p-[30px]">
        ...
        <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
          <div className="p-6">
            ...
            <h5 className="block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
              {dataPharmacy?.pharmacy_name}
            </h5>
            <p className="block font-sans text-base antialiased font-light leading-relaxed text-inherit">
              {dataPharmacy?.address}
            </p>
          </div>
          <div className="p-6 pl-2 pt-0">
            <Link to="#" className="inline-block">
              <button
                ...
                type="button"
              >
                pharmacist : {dataPharmacy?.pharmacist_name}
                <FaRocket />
              </button>
            </Link>
          </div>
