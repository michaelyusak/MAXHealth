...
const TelemedicineLandingUserPageLoading = (): React.ReactElement => {
  return (
    <div className="w-[180px] md:w-[300px] xl:w-[350px] h-[350px] xl:h-[400px] bg-gray-300 animate-pulse rounded-xl flex shadow-[0px_0px_15px_0px_rgba(0,0,0,0.3)] flex-col items-center justify-between px-[20px] py-[10px]">
