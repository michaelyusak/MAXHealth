...
import { HandleSendVerificationEmail } from "../util/API";
import { HandleShowToast } from "../util/ShowToast";
import { ToastContext } from "../contexts/ToastData";
import { BiMailSend } from "react-icons/bi";

const VerificationWaitingPage = (): React.ReactElement => {
  ...
  return (
    <div className="relative w-[80%] lg:w-[25%] h-[50%] bg-white shadow-[0_5px_60px_-8px_rgba(0,0,0,0.3)] rounded-[10px] p-[30px] flex flex-col gap-[25px]">
      <div className={"h-[100%] flex items-center justify-center"}>
        <div className="flex flex-col items-center gap-[25px]">
          ...
          <h1 className="text-[24px] font-[600]">Verification</h1>

          <article className="text-center">
            <p>Verification email has been sent to your registered email.</p>
            <p>
              Please check your inbox and click the button to verify your
              account.
            </p>
          </article>
